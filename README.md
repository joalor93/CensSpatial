...
SAEMres = SAEMSCL(cc,y,cens.type="left",trend="1st",coords=coords,
               ...
               inits.sigmae=cov.ini[2],inits.phi=cov.ini[1], search=T,
...
### Seminaive sintax
seminaiveres = Seminaive(data=dataobs,y.col=3,coords.col=1:2,covar=F,cc=as.matrix(cc),trend="1st", cov.model="gaussian",fix.nugget=F,nugget=170,kappa=2, thetaini=c(cov.ini[2],cov.ini[1]),cons=c(0.1,2,0.5),MaxIter=500,copred=coordspred,
             cutoff = lod)


### Naive 1 and Naive 2 sintax
naive12res = algnaive12(data=dataobs,y.col=3,coords.col=1:2,covar=F,cc=as.matrix(cc),trend="1st",
               cov.model="gaussian",fix.nugget=F,nugget=170,kappa=2,
               thetaini=c(cov.ini[2],cov.ini[1]),copred=coordspred,cutoff=lod)
```
...
#> Value -349.605 711.21 726.841 712.113
#> 
#> -------
#> Details
#> -------
...
#> SAEM (best) 361.961 -0.070 -0.303  951.629 220.006 362.544 -349.605  711.210
#>                  BIC
#> Seminaive   1000.654
#> Naive_1      903.891
#> Naive_2     1025.122
...
dp$expvper
#>             at3        m03
#> 9  atypical obs 0.05446722
#> 77 atypical obs 0.05535268
#> 92 atypical obs 0.05542131

### scale matrix perturbation##
dp$smper
#>             at2        m02
#> 20 atypical obs 0.05619639
#> 21 atypical obs 0.05804641
#> 77 atypical obs 0.05995495
#> 92 atypical obs 0.07316887
```
